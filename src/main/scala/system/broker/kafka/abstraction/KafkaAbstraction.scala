...
/** Abstract trait for Kafka publishers Provides type-safe message publishing with serialization
  */
...
/** Abstract trait for Kafka consumers Provides type-safe message consumption with deserialization
  */
trait KafkaConsumerAbstraction[T] {

  /** Start consuming messages from Kafka The processor function handles each message and returns
    * processing result
    */
  def startConsuming(
