...
import org.interscity.htc.model.mobility.entity.event.data.bus.{ BusLoadPassengerData, BusUnloadPassengerData }
...
import org.interscity.htc.model.mobility.entity.state.enumeration.MovableStatusEnum.{ Moving, Ready, Start, WaitingLoadPassenger, WaitingSignal, WaitingUnloadPassenger }
