...
/** Dynamic cost information for a link, reflecting real-time traffic conditions. This data is
  * cached in Redis and updated periodically by Link actors.
  *
  ...
  * @param baseCost
  *   Base cost (typically link length in meters)
  * @param congestionFactor
  *   Congestion multiplier (1.0 = no congestion, >1.0 = congested)
  * @param currentSpeed
  *   Current average speed on link (m/s)
  * @param freeFlowSpeed
  *   Free-flow speed when uncongested (m/s)
  * @param vehicleCount
  *   Number of vehicles currently on link
  * @param capacity
  *   Maximum vehicle capacity
  * @param incidentFactor
  *   Additional cost due to incidents (0.0 = none, >0.0 = incident)
  * @param lastUpdateTick
  *   Simulation tick when this was last updated
  * @param timestamp
