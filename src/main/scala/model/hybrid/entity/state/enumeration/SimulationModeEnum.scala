...
/** Enumeration defining the simulation mode for hybrid simulation.
  ...
  *
  * The mode is set per link, and ALL vehicles entering that link will adopt the link's simulation
  * mode.
  */
enum SimulationModeEnum:
  /** Mesoscopic simulation mode - aggregate speed calculations based on link density. Used for
    * large-scale, city-wide simulations where individual vehicle dynamics are not critical. More
    * computationally efficient.
    */
  case MESO

  /** Microscopic simulation mode - individual vehicle dynamics with car-following models. Used for
    * detailed analysis of specific corridors, intersections, or regions where vehicle-to-vehicle
    * interactions are important. More computationally intensive.
    *
    * In MICRO mode:
