...
/** Microscopic state for a bicycle in MICRO simulation mode.
  ...
  *   Maximum acceleration (default: 1.0 m/s² - low)
  * @param maxDeceleration
  *   Maximum deceleration (default: 3.0 m/s²)
  * @param minGap
  *   Minimum safe gap (default: 1.5 m - smaller than car)
  * @param desiredVelocity
  *   Desired velocity (default: 5.56 m/s = 20 km/h)
  * @param reactionTime
  *   Cyclist reaction time (default: 1.2 s)
  * @param vehicleLength
  *   Bicycle length (default: 2.0 m)
  * @param prefersBikeLane
  *   Whether cyclist prefers bike lane
  * @param canUseSidewalk
  *   Whether allowed to use sidewalk (context-dependent)
  * @param desiredLane
