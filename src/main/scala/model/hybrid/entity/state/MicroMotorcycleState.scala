...
/** Microscopic state for a motorcycle in MICRO simulation mode.
  ...
  *   Maximum acceleration (default: 3.5 m/s² - HIGHER than car)
  * @param maxDeceleration
  *   Maximum deceleration (default: 5.0 m/s²)
  * @param minGap
  *   Minimum safe gap (default: 1.5 m - smaller than car)
  * @param desiredVelocity
  *   Desired velocity (default: 16.67 m/s = 60 km/h)
  * @param reactionTime
  *   Rider reaction time (default: 0.9 s - faster than car)
  * @param vehicleLength
  *   Motorcycle length (default: 2.5 m)
  * @param canFilterLanes
  *   Whether lane splitting/filtering is allowed
  * @param aggressiveness
  *   Aggressiveness factor [0-1] affecting gap acceptance
  * @param desiredLane
  *   Target lane for lane change
  * @param laneChangeProgress
  *   Progress of lane change (0.0 to 1.0)
  * @param filteringBetweenLanes
  *   Currently filtering between two lanes
  */
