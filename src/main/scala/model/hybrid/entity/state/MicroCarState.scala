...
/** Microscopic state for a car in MICRO simulation mode.
  *
  * This state is activated when a car enters a link configured with MICRO mode. It contains all the
  * kinematic and perceptual information needed for car-following models and lane-change models.
  *
  * Default parameters are based on typical passenger car characteristics.
  *
  * @param positionInLink
  *   Position from link start (meters)
  * @param velocity
  *   Current velocity (m/s)
  * @param acceleration
  *   Current acceleration (m/s²)
  * @param currentLane
  *   Current lane number (0-indexed)
  * @param leaderVehicle
  *   ID of the vehicle ahead
  * @param gapToLeader
  *   Gap to leader (meters, bumper-to-bumper)
  * @param leaderVelocity
  *   Velocity of the leader (m/s)
  * @param maxAcceleration
  *   Maximum acceleration (default: 2.6 m/s²)
  * @param maxDeceleration
  *   Maximum deceleration (default: 4.5 m/s²)
  * @param minGap
  *   Minimum safe gap (default: 2.0 m)
  * @param desiredVelocity
  *   Desired free-flow velocity (default: 13.89 m/s = 50 km/h)
  * @param reactionTime
  *   Driver reaction time (default: 1.0 s)
  * @param vehicleLength
  *   Length of the car (default: 4.5 m)
  * @param desiredLane
  *   Target lane for lane change
  * @param laneChangeProgress
  *   Progress of lane change (0.0 to 1.0)
  */
