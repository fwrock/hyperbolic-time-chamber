...
/** Microscopic state for a bus in MICRO simulation mode.
  ...
  *   Maximum acceleration (default: 1.2 m/s² - slower than car)
  * @param maxDeceleration
  *   Maximum deceleration (default: 3.5 m/s²)
  * @param minGap
  *   Minimum safe gap (default: 3.0 m - larger than car)
  * @param desiredVelocity
  *   Desired velocity (default: 11.11 m/s = 40 km/h)
  * @param reactionTime
  *   Driver reaction time (default: 1.5 s - longer than car)
  * @param vehicleLength
  *   Bus length (default: 12.0 m - much longer than car)
  * @param capacity
  *   Passenger capacity
  * @param currentPassengers
  *   Current number of passengers
  * @param nextBusStop
  *   ID of the next bus stop
  * @param busLaneRestricted
  *   Whether restricted to bus lanes
  * @param desiredLane
  *   Target lane for lane change
  * @param laneChangeProgress
  *   Progress of lane change (0.0 to 1.0)
  * @param canChangeLane
  *   Whether bus can change lanes (usually restricted)
  */
