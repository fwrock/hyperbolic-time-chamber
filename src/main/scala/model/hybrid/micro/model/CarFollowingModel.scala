...
/** Car-following model interface.
  *
  * Defines the contract for microscopic car-following behavior. Models calculate safe velocities
  * and accelerations based on:
...
trait CarFollowingModel {
  ...
  /** Calculate safe velocity considering leader vehicle.
    ...
    *   Current velocity of ego vehicle (m/s)
    * @param desiredVelocity
    *   Desired free-flow velocity (m/s)
    * @param gap
    *   Gap to leader vehicle (meters)
    * @param leaderVelocity
    *   Leader vehicle velocity (m/s)
  ...
  /** Calculate acceleration for next time step.
    ...
    * @param safeVelocity
    *   Safe velocity from calculateSafeVelocity (m/s)
    * @param maxAcceleration
    *   Maximum acceleration (m/s²)
    * @param maxDeceleration
    *   Maximum deceleration (m/s²)
  ...
  /** Model name for debugging/logging.
    *
    * @return
    *   Model name (e.g., "Krauss", "IDM", "Gipps")
    */
