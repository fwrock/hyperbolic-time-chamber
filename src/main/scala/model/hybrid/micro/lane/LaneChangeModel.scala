...
/** Lane change decision result.
  *
  * @param shouldChange
  *   Whether vehicle should change lanes
  * @param targetLane
  *   Target lane (if shouldChange = true)
  * @param reason
  *   Reason for decision
  * @param urgency
...
/** Lane-change model interface.
  *
  * Defines the contract for lane-change behavior. Models decide when and where to change lanes
  * based on:
...
trait LaneChangeModel {
  ...
  /** Evaluate lane change decision.
    ...
    * @param currentLane
    *   Current lane
    * @param leaderInCurrentLane
    *   Leader in current lane
    * @param followerInCurrentLane
    *   Follower in current lane
    * @param leaderInTargetLane
    *   Leader in target lane (if any)
    * @param followerInTargetLane
    *   Follower in target lane (if any)
    * @param targetLane
    *   Target lane to evaluate
    * @param numberOfLanes
