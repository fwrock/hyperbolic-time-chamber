...
/** MOBIL (Minimizing Overall Braking Induced by Lane Changes) lane-change model.
  *
  * Reference: Kesting, Treiber, Helbing (2007) "General Lane-Changing Model MOBIL for Car-Following
  * Models"
  *
  * MOBIL considers:
  *   1. Incentive criterion: Is there acceleration advantage? 2. Safety criterion: Is rear gap
  *      safe? 3. Politeness factor: How much to consider other drivers
  *
  * Key parameters:
  ...
  *
  * @param politeness
  *   Politeness factor [0.0 - 1.0]
  * @param safeDeceleration
  *   Safe deceleration for followers (m/s²)
  * @param accelerationThreshold
  *   Min acceleration advantage (m/s²)
  * @param biasToRight
  *   Bias factor for keeping right [0.0 - 1.0]
  * @param laneChangeDuration
  *   Time to complete lane change (seconds)
  * @param carFollowingModel
  *   Car-following model for acceleration calculations
  */
