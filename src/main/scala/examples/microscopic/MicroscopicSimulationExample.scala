...
import model.mobility.entity.state.{ CarState, LinkState }
...
/** Exemplo de configuração para simulação microscópica de tráfego
  ...
  *   1. Links com diferentes tipos de simulação (micro vs meso) 2. Veículos com diferentes
  *      personalidades 3. Cenários de teste específicos
  */
    ...
    val vehicles = (1 to 50).map {
      i =>
        ...
        CarState(
          ...
          laneChangeThreshold =
            0.1 + aggressiveness * 0.2 + scala.util.Random.nextGaussian() * 0.05,
