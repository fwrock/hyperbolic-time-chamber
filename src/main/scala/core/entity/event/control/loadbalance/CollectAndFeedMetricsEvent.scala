...
/** Internal self-message sent periodically by LoadBalanceManager to collect shard-location and
  * entity-count data from the allocator and feed it into the balancing strategy's kd-tree.
  *
