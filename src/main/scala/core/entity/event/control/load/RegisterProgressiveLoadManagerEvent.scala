...
/**
 * Sent to the GlobalTimeManager to register the ProgressiveLoadDataManager
 * for tick-windowed actor creation coordination.
 *
 * @param progressiveLoadManager  reference to the ProgressiveLoadDataManager
