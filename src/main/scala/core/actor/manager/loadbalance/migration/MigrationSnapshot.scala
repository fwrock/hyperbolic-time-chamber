...
case class MigrationSnapshot(
  ...
  currentStopNode: Long = 0L,
  linkVehicleEntryTick: Map[Long, Long] = Map.empty,
  linkVehicleWaitingSeconds: Map[Long, Double] = Map.empty
)
