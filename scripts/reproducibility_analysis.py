  ...
  python reproducibility_analysis.py --create-config
    ...
    try:
        ...
        if results:
            ...
            print(f"  • reproducibility_report.json - Relatório completo")
            print(f"  • reproducibility_dashboard.png - Dashboard visual")
            print(f"  • basic_metrics_comparison.png - Comparação de métricas")
            print(f"  • temporal_reproducibility.png - Análise temporal")
            print(f"  • similarity_scores.png - Scores de similaridade")
            print("="*80 + "\n")
