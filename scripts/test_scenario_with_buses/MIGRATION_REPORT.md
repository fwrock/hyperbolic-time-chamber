...
- **Directory:** `test_scenario_with_buses`
...
export HTC_SIMULATION_DATA_PATH=/home/dean/PhD/hyperbolic-time-chamber/scripts/test_scenario_with_buses
...
```bash
docker run -v /home/dean/PhD/hyperbolic-time-chamber/scripts/test_scenario_with_buses:/app/scenario \
