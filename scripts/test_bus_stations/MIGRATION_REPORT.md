...
export HTC_SIMULATION_DATA_PATH=/home/dean/PhD/hyperbolic-time-chamber/scripts/test_bus_stations
...
```bash
docker run -v /home/dean/PhD/hyperbolic-time-chamber/scripts/test_bus_stations:/app/scenario \
