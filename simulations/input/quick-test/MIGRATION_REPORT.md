...
- **Directory:** `output/hybrid_scenario_9`
...
export HTC_SIMULATION_DATA_PATH=/home/dean/PhD/hyperbolic-time-chamber/scripts/output/hybrid_scenario_9
...
```bash
docker run -v /home/dean/PhD/hyperbolic-time-chamber/scripts/output/hybrid_scenario_9:/app/scenario \
